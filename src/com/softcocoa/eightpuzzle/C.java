...
public class C {
	public static String APP_NAME = "EightPuzzle";
	...
	public static int NODE_LIMIT = 10000;
	
	public static int INITIAL_CLOSED_LIST_SIZE = 5000;
	public static int INITIAL_STEP_LIST_SIZE = 1000;
}
